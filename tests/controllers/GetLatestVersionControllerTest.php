...
class GetLatestVersionControllerTest extends TestCase
{
    use WithoutEvents;
    ...
    public function testGetLatestVersion() : void
    {
        ...
        // when
        $result = $this->get('/version-latest/'.$fileID);
    ...
    public function testGetLatestVersionWhenOnlyOneExists() : void
    {
        // given
            $fileID = 3;
    ...
    public function testGetLatestVersionWithIDThatDoesNotExist() : void
    {
        // given
        $fileID = 2221;
    ...
    public function testGetLatestVersionWithIdThatIsNotInteger() : void
    {
        // given
    ...
    public function testGetLatestVersionOfFileThatIsSoftDeleted() : void
    {
        // given
        $fileID = 2;
